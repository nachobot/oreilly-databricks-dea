...
# MAGIC %md
# MAGIC From Delta Table to Dataframe to View - continuously streaming View
...
# MAGIC %md
# MAGIC We are querying a streaming object - Aggregation --> stateful streaming query
# MAGIC
