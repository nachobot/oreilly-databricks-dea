...
-- TODO Modify this code to use Python spark.readStream
...
-- TODO Move the source files to Unity Catalog storage location
-- "dbfs:/mnt/DE-Associate-Book/datasets/school/enrollments-dlt-raw"
-- abfss://autoloader-source@demo25db.dfs.core.windows.net/json-data//DE-Associate-Book/datasets/school/enrollments-dlt-raw

CREATE OR REFRESH STREAMING TABLE enrollments_raw
COMMENT "The raw courses enrollments, ingested from enrollments-dlt-raw folder - AutoLoader Stream"
AS SELECT * FROM cloud_files("dbfs:/mnt/DE-Associate-Book/datasets/school/enrollments-dlt-raw","json",map("cloudFiles.inferColumnTypes", "true"))
...
COMMENT "The students lookup table (Live Table), ingested from students-json, handles any new changes in the data."
